...
def main():
    ...
    """
    # if (len(xw_yw_G) < 2) or (len(xw_yw_P) < 2):
    #     print("Could not find all blocks. Exiting...")
    #     return 1
    ...
    green_target = [300, 50, 15]
    yellow_target = [300, 15, 15]

    move_block(pub_command, loop_rate, xw_yw_G, green_target, vel, accel)
    move_block(pub_command, loop_rate, xw_yw_Y, yellow_target, vel, accel)
    # move_block(pub_command, loop_rate, xw_yw_G[1], gween2, vel, accel)
    # move_block(pub_command, loop_rate, xw_yw_P[0], pink1, vel, accel)
    # move_block(pub_command, loop_rate, xw_yw_P[1], pink2, vel, accel)
