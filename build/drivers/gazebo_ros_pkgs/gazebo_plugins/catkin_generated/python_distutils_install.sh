...
echo_and_run cd "/home/evan/catkin_ece470/src/drivers/gazebo_ros_pkgs/gazebo_plugins"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/evan/catkin_ece470/src/drivers/gazebo_ros_pkgs/gazebo_plugins/setup.py" \
     \
    build --build-base "/home/evan/catkin_ece470/build/drivers/gazebo_ros_pkgs/gazebo_plugins" \
    install \
    --root="${DESTDIR-/}" \
