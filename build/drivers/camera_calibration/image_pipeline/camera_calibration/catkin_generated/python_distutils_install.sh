...
echo_and_run cd "/home/evan/catkin_ece470/src/drivers/camera_calibration/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/evan/catkin_ece470/src/drivers/camera_calibration/image_pipeline/camera_calibration/setup.py" \
     \
    build --build-base "/home/evan/catkin_ece470/build/drivers/camera_calibration/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
